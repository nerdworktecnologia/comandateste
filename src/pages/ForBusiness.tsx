...
import { Store, TrendingUp, Users, Smartphone, ArrowRight, CheckCircle, Zap, Shield } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight mb-4">O que está incluso</h2>
              <p className="text-muted-foreground">Sem surpresas. Tudo transparente desde o início.</p>
            </div>
